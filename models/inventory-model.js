...
async function deleteClass(classification_id) {
    try {
...
module.exports = {getClassifications, getInventoryByClassificationId, getDetailsByInvId, addNewClass, addNewVehicle, updateInventory, deleteInventory, deleteClass}